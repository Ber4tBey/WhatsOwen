...
Owen.addCommand({pattern: 'tagall ?(.*)', fromMe: true, desc: Lang.TAGALL_DESC }, (async (message, match) => {
...
Owen.addCommand({pattern: 'stam$', fromMe: true, desc: stag_dsc }, (async (message, match) => {
