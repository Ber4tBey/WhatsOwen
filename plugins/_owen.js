...
if (Config.WORKTYPE == 'private') {
    ...
    Owen.addCommand({pattern: 'owen ?(.*)', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
    ...
    Owen.addCommand({pattern: 'Owen ?(.*)', fromMe: false, dontAddCommandList: true}, (async (message, match) => {
