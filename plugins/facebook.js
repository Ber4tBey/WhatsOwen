...
Owen.addCommand({pattern: 'fb ?(.*)', fromMe: wk, desc: CLR_DESC, usage: 'fb https://www.facebook.com/Google/videos/10156367314197838'}, (async (message, match) => {
  ...
  var payload = await WhatsOwenStack.facebook(match[1])
  var auth_message = await WhatsOwenStack.facebook_message(Config.LANG)
