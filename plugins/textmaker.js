...
Owen.addCommand({pattern: 'textmaker$', fromMe: wk, desc: desc_msg}, (async (message, match) => {
    var t1 = ''
    var t2 = ''
    var t3 = ''
    var t4 = ''
...
Owen.addCommand({pattern: 'textdevil ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    thiccysapi.textpro("https://textpro.me/create-neon-devil-wings-text-effect-online-free-1014.html",
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsOwenDuplicated/devil.png', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsOwenDuplicated/devil.png'), MessageType.image, { mimetype: Mimetype.png, caption: 'Made by WhatsOwen' })
              })
          } catch(err) { 
              console.log(err)
          } 
...
Owen.addCommand({pattern: 'textsci ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    thiccysapi.textpro("https://textpro.me/create-science-fiction-text-effect-online-free-1038.html",
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsOwenDuplicated/sci.png', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsOwenDuplicated/sci.png'), MessageType.image, { mimetype: Mimetype.png, caption: 'Made by WhatsOwen' })
              })
          } catch(err) { 
              console.log(err)
          } 
...
Owen.addCommand({pattern: 'textleaf ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    var img = await WhatsOwenStack.ephoto(match[1], 'https://en.ephoto360.com/dark-green-typography-online-359.html')
    var buffer_data = await axios.get(img.image, { responseType: 'arraybuffer'})
    await message.sendMessage(Buffer.from(buffer_data.data), MessageType.image, { mimetype: Mimetype.png, caption: 'Made by WhatsOwen' })
}));
Owen.addCommand({pattern: 'textmatrix ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    var img = await WhatsOwenStack.ephoto(match[1], 'https://en.ephoto360.com/matrix-text-effect-154.html')
    var buffer_data = await axios.get(img.image, { responseType: 'arraybuffer'})
    await message.sendMessage(Buffer.from(buffer_data.data), MessageType.image)
}));
Owen.addCommand({pattern: 'text2gradient ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    var img = await WhatsOwenStack.ephoto(match[1], 'https://en.ephoto360.com/create-3d-gradient-text-effect-online-600.html')
    var buffer_data = await axios.get(img.image, { responseType: 'arraybuffer'})
    await message.sendMessage(Buffer.from(buffer_data.data), MessageType.image)
}));
Owen.addCommand({pattern: 'textballoon ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    var img = await WhatsOwenStack.ephoto(match[1], 'https://en.ephoto360.com/writing-your-name-on-hot-air-balloon-506.html')
    var buffer_data = await axios.get(img.image, { responseType: 'arraybuffer'})
    await message.sendMessage(Buffer.from(buffer_data.data), MessageType.image)
}));
Owen.addCommand({pattern: 'textsnow ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    var img = await WhatsOwenStack.ephoto(match[1], 'https://en.ephoto360.com/snow-on-text-online-107.html')
    var buffer_data = await axios.get(img.image, { responseType: 'arraybuffer'})
    await message.sendMessage(Buffer.from(buffer_data.data), MessageType.image)
}));
Owen.addCommand({pattern: 'text2gold ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    var img = await WhatsOwenStack.ephoto(match[1], 'https://en.ephoto360.com/gold-text-effect-pro-271.html')
    var buffer_data = await axios.get(img.image, { responseType: 'arraybuffer'})
    await message.sendMessage(Buffer.from(buffer_data.data), MessageType.image)
}));
Owen.addCommand({pattern: 'text5graf ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
  var img = await WhatsOwenStack.ephoto(match[1], 'https://en.ephoto360.com/graffiti-color-199.html')
  var buffer_data = await axios.get(img.image, { responseType: 'arraybuffer'})
  await message.sendMessage(Buffer.from(buffer_data.data), MessageType.image)
}));
Owen.addCommand({pattern: 'text3fire ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    var img = await WhatsOwenStack.ephoto(match[1], 'https://en.ephoto360.com/dragon-fire-text-effect-111.html')
    var buffer_data = await axios.get(img.image, { responseType: 'arraybuffer'})
    await message.sendMessage(Buffer.from(buffer_data.data), MessageType.image, { mimetype: Mimetype.png, caption: 'Made by WhatsOwen' })
}));
Owen.addCommand({pattern: 'text2space ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    var img = await WhatsOwenStack.ephoto(match[1], 'https://en.ephoto360.com/create-galaxy-style-free-name-logo-438.html')
    var buffer_data = await axios.get(img.image, { responseType: 'arraybuffer'})
    await message.sendMessage(Buffer.from(buffer_data.data), MessageType.image, { mimetype: Mimetype.png, caption: 'Made by WhatsOwen'})
}));
Owen.addCommand({pattern: 'text3space ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    var img = await WhatsOwenStack.ephoto(match[1], 'https://en.ephoto360.com/galaxy-text-effect-116.html')
    var buffer_data = await axios.get(img.image, { responseType: 'arraybuffer'})
    await message.sendMessage(Buffer.from(buffer_data.data), MessageType.image, { mimetype: Mimetype.png, caption: 'Made by WhatsOwen' })
}));
Owen.addCommand({pattern: 'textgold ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    var img = await WhatsOwenStack.ephoto(match[1], 'https://en.ephoto360.com/modern-gold-3-212.html')
    var buffer_data = await axios.get(img.image, { responseType: 'arraybuffer'})
    await message.sendMessage(Buffer.from(buffer_data.data), MessageType.image, { mimetype: Mimetype.png, caption: 'Made by WhatsOwen' })
}));
Owen.addCommand({pattern: 'text3space ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
...
Owen.addCommand({pattern: 'textangel ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    var img = await WhatsOwenStack.ephoto(match[1], 'https://en.ephoto360.com/wings-galaxy-206.html')
    var buffer_data = await axios.get(img.image, { responseType: 'arraybuffer'})
    await message.sendMessage(Buffer.from(buffer_data.data), MessageType.image, { mimetype: Mimetype.png, caption: 'Made by WhatsOwen' })
}));
Owen.addCommand({pattern: 'text2pink ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    var img = await WhatsOwenStack.ephoto(match[1], 'https://en.ephoto360.com/create-a-blackpink-neon-logo-text-effect-online-710.html')
    var buffer_data = await axios.get(img.image, { responseType: 'arraybuffer'})
    await message.sendMessage(Buffer.from(buffer_data.data), MessageType.image, { mimetype: Mimetype.png, caption: 'Made by WhatsOwen' })
}));
Owen.addCommand({pattern: 'textabear ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    var img = await WhatsOwenStack.ephoto(match[1], 'https://en.ephoto360.com/create-funny-animations-of-a-traveling-bear-701.html')
    var buffer_data = await axios.get(img.image, { responseType: 'arraybuffer'})
    await message.sendMessage(Buffer.from(buffer_data.data), MessageType.video, { mimetype: Mimetype.png, caption: 'Made by WhatsOwen', mimetype: Mimetype.gif })
}));
Owen.addCommand({pattern: 'text6neon ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    var img = await WhatsOwenStack.ephoto(match[1], 'https://en.ephoto360.com/create-light-effects-green-neon-online-429.html')
    var buffer_data = await axios.get(img.image, { responseType: 'arraybuffer'})
    await message.sendMessage(Buffer.from(buffer_data.data), MessageType.image)
}));
Owen.addCommand({pattern: 'textheart ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    var img = await WhatsOwenStack.ephoto(match[1], 'https://en.ephoto360.com/write-name-on-heart-with-wings-gifs-430.html')
    var buffer_data = await axios.get(img.image, { responseType: 'arraybuffer'})
    await message.sendMessage(Buffer.from(buffer_data.data), MessageType.video, { mimetype: Mimetype.png, caption: 'Made by WhatsOwen', mimetype: Mimetype.gif })
}));
Owen.addCommand({pattern: 'text4graf ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    var img = await WhatsOwenStack.ephoto(match[1], 'https://en.ephoto360.com/text-graffiti-3d-208.html')
    var buffer_data = await axios.get(img.image, { responseType: 'arraybuffer'})
    await message.sendMessage(Buffer.from(buffer_data.data), MessageType.image, { mimetype: Mimetype.png, caption: 'Made by WhatsOwen' })
}));
Owen.addCommand({pattern: 'textpuppy ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    var img = await WhatsOwenStack.ephoto(match[1], 'https://en.ephoto360.com/create-puppy-cute-animated-online-478.html')
    var buffer_data = await axios.get(img.image, { responseType: 'arraybuffer'})
    await message.sendMessage(Buffer.from(buffer_data.data), MessageType.video, { mimetype: Mimetype.png, caption: 'Made by WhatsOwen', mimetype: Mimetype.gif })
}));
Owen.addCommand({pattern: 'textroad ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    var img = await WhatsOwenStack.ephoto(match[1], 'https://en.ephoto360.com/create-glowing-text-effects-online-706.html')
    var buffer_data = await axios.get(img.image, { responseType: 'arraybuffer'})
    await message.sendMessage(Buffer.from(buffer_data.data), MessageType.image, { mimetype: Mimetype.png, caption: 'Made by WhatsOwen' })
}));
Owen.addCommand({pattern: 'textsad ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    var img = await WhatsOwenStack.ephoto(match[1], 'https://en.ephoto360.com/write-text-on-wet-glass-online-589.html')
    var buffer_data = await axios.get(img.image, { responseType: 'arraybuffer'})
    await message.sendMessage(Buffer.from(buffer_data.data), MessageType.image, { mimetype: Mimetype.png, caption: 'Made by WhatsOwen' })
}));
Owen.addCommand({pattern: 'text3pubg ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    var img = await WhatsOwenStack.ephoto(match[1], 'https://en.ephoto360.com/create-the-cover-game-playerunknown-s-battlegrounds-401.html')
    var buffer_data = await axios.get(img.image, { responseType: 'arraybuffer'})
    await message.sendMessage(Buffer.from(buffer_data.data), MessageType.image, { mimetype: Mimetype.png, caption: 'Made by WhatsOwen' })
}));
Owen.addCommand({pattern: 'textpubg ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    var vid = await WhatsOwenStack.ephoto(match[1], 'https://en.ephoto360.com/create-pubg-style-glitch-video-avatar-554.html')
    var buffer_data = await axios.get(vid.image, { responseType: 'arraybuffer'})
    await message.sendMessage(Buffer.from(buffer_data.data), MessageType.video, { mimetype: Mimetype.png, caption: 'Made by WhatsOwen', mimetype: Mimetype.mp4 })
}));
Owen.addCommand({pattern: 'text2pubg ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    var vid = await WhatsOwenStack.ephoto(match[1], 'https://en.ephoto360.com/lightning-pubg-video-logo-maker-online-615.html')
    var buffer_data = await axios.get(vid.image, { responseType: 'arraybuffer'})
    await message.sendMessage(Buffer.from(buffer_data.data), MessageType.video, { mimetype: Mimetype.png, caption: 'Made by WhatsOwen', mimetype: Mimetype.mp4 })
}));
Owen.addCommand({pattern: 'text2devil ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    thiccysapi.textpro("https://textpro.me/create-green-horror-style-text-effect-online-1036.html",
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsOwenDuplicated/devil2.png', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsOwenDuplicated/devil2.png'), MessageType.image, { mimetype: Mimetype.png, caption: 'Made by WhatsOwen' })
              })
          } catch(err) { 
              console.log(err)
          } 
...
Owen.addCommand({pattern: 'texthub ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    ...
    thiccysapi.textpro("https://textpro.me/pornhub-style-logo-online-generator-free-977.html",
        [`${topText}`, `${bottomText}`]
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsOwenDuplicated/hub.png', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsOwenDuplicated/hub.png'), MessageType.image, { mimetype: Mimetype.png, caption: 'Made by WhatsOwen' })
              })
          } catch(err) { 
              console.log(err)
          } 
...
Owen.addCommand({pattern: 'textretro ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    var topText, bottomText; 
    if (match[1].includes(';')) {
        var split = match[1].split(';');
        topText = split[0];
    ...
    thiccysapi.textpro("https://textpro.me/video-game-classic-8-bit-text-effect-1037.html",
        [`${topText}`, `${bottomText}`]
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsOwenDuplicated/retr.png', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsOwenDuplicated/retr.png'), MessageType.image, { mimetype: Mimetype.png, caption: 'Made by WhatsOwen' })
              })
          } catch(err) { 
              console.log(err)
          } 
...
Owen.addCommand({pattern: 'text3graf ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    thiccysapi.textpro("https://textpro.me/break-wall-text-effect-871.html",
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsOwenDuplicated/t3gr.png', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsOwenDuplicated/t3gr.png'), MessageType.image, { mimetype: Mimetype.png, caption: 'Made by WhatsOwen' })
              })
          } catch(err) { 
              console.log(err)
          } 
...
Owen.addCommand({pattern: 'textberry ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    thiccysapi.textpro("https://textpro.me/create-berry-text-effect-online-free-1033.html",
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsOwenDuplicated/bry.png', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsOwenDuplicated/bry.png'), MessageType.image, { mimetype: Mimetype.png, caption: 'Made by WhatsOwen' })
              })
          } catch(err) { 
              console.log(err)
          } 
...
Owen.addCommand({pattern: 'text4sand ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    thiccysapi.textpro("https://textpro.me/create-a-summery-sand-writing-text-effect-988.html",
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsOwenDuplicated/t4snd.png', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsOwenDuplicated/t4snd.png'), MessageType.image, { mimetype: Mimetype.png, caption: 'Made by WhatsOwen' })
              })
          } catch(err) { 
              console.log(err)
          } 
...
Owen.addCommand({pattern: 'text3sand ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    thiccysapi.textpro("https://textpro.me/sand-engraved-3d-text-effect-989.html",
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsOwenDuplicated/t3snd.png', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsOwenDuplicated/t3snd.png'), MessageType.image, { mimetype: Mimetype.png, caption: 'Made by WhatsOwen' })
              })
          } catch(err) { 
              console.log(err)
          } 
...
Owen.addCommand({pattern: 'text2sand ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    thiccysapi.textpro("https://textpro.me/sand-writing-text-effect-online-990.html",
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsOwenDuplicated/t2snd.png', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsOwenDuplicated/t2snd.png'), MessageType.image, { mimetype: Mimetype.png, caption: 'Made by WhatsOwen' })
              })
          } catch(err) { 
              console.log(err)
          } 
...
Owen.addCommand({pattern: 'textsand ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    thiccysapi.textpro("https://textpro.me/write-in-sand-summer-beach-free-online-991.html",
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsOwenDuplicated/snd.png', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsOwenDuplicated/snd.png'), MessageType.image, { mimetype: Mimetype.png, caption: 'Made by WhatsOwen' })
              })
          } catch(err) { 
              console.log(err)
          } 
...
Owen.addCommand({pattern: 'text2fire ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    thiccysapi.textpro("https://textpro.me/halloween-fire-text-effect-940.html",
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsOwenDuplicated/fh.png', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsOwenDuplicated/fh.png'), MessageType.image, { mimetype: Mimetype.png, caption: 'Made by WhatsOwen' })
              })
          } catch(err) { 
              console.log(err)
          } 
...
Owen.addCommand({pattern: 'textpink ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    thiccysapi.textpro("https://textpro.me/blood-text-on-the-frosted-glass-941.html",
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsOwenDuplicated/tpink.png', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsOwenDuplicated/tpink.png'), MessageType.image, { mimetype: Mimetype.png, caption: 'Made by WhatsOwen' })
              })
          } catch(err) { 
              console.log(err)
          } 
...
Owen.addCommand({pattern: 'text2blood ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    thiccysapi.textpro("https://textpro.me/blood-text-on-the-frosted-glass-941.html",
        `${match[1]}`
        ).then(async (data) => { 
          try { 
              ...
              await download(`${data}`, '/root/WhatsOwenDuplicated/cbld.png', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsOwenDuplicated/cbld.png'), MessageType.image, { mimetype: Mimetype.png, caption: 'Made by WhatsOwen' })
              })
          } catch(err) { 
              console.log(err)
          } 
...
Owen.addCommand({pattern: 'textblood ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    thiccysapi.textpro("https://textpro.me/horror-blood-text-effect-online-883.html",
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsOwenDuplicated/bld.png', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsOwenDuplicated/bld.png'), MessageType.image, { mimetype: Mimetype.png, caption: 'Made by WhatsOwen' })
              })
          } catch(err) { 
              console.log(err)
          } 
...
Owen.addCommand({pattern: 'text2light ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    thiccysapi.textpro("https://textpro.me/online-thunder-text-effect-generator-1031.html",
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsOwenDuplicated/t2lgh.png', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsOwenDuplicated/t2lgh.png'), MessageType.image, { mimetype: Mimetype.png, caption: 'Made by WhatsOwen' })
              })
          } catch(err) { 
              console.log(err)
          } 
...
Owen.addCommand({pattern: 'textrobo ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    thiccysapi.textpro("https://textpro.me/online-thunder-text-effect-generator-1031.html",
        `${match[1]}`
        ).then(async (data) => { 
          try { 
              ...
              await download(`${data}`, '/root/WhatsOwenDuplicated/robo.png', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsOwenDuplicated/robo.png'), MessageType.image, { mimetype: Mimetype.png, caption: 'Made by WhatsOwen' })
              })
          } catch(err) { 
              console.log(err)
          } 
...
Owen.addCommand({pattern: 'text3d ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    var topText, bottomText; 
    if (match[1].includes(';')) {
        var split = match[1].split(';');
        topText = split[0];
    ...
    thiccysapi.textpro("https://textpro.me/create-layered-text-effects-online-free-1032.html",
        [`${topText}`, `${bottomText}`]
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsOwenDuplicated/3dl.png', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsOwenDuplicated/3dl.png'), MessageType.image, { mimetype: Mimetype.png, caption: 'Made by WhatsOwen' })
              })
          } catch(err) { 
              console.log(err)
          } 
...
Owen.addCommand({pattern: 'textart ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    thiccysapi.textpro("https://textpro.me/online-multicolor-3d-paper-cut-text-effect-1016.html",
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsOwenDuplicated/tart.png', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsOwenDuplicated/tart.png'), MessageType.image, { mimetype: Mimetype.png, caption: 'Made by WhatsOwen' })
              })
          } catch(err) { 
              console.log(err)
          } 
...
Owen.addCommand({pattern: 'textwcolor ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    thiccysapi.textpro("https://textpro.me/create-a-free-online-watercolor-text-effect-1017.html",
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsOwenDuplicated/wcolor.png', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsOwenDuplicated/wcolor.png'), MessageType.image, { mimetype: Mimetype.png, caption: 'Made by WhatsOwen' })
              })
          } catch(err) { 
              console.log(err)
          } 
...
Owen.addCommand({pattern: 'textmagma ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    thiccysapi.textpro("https://textpro.me/create-a-magma-hot-text-effect-online-1030.html",
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsOwenDuplicated/magma.png', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsOwenDuplicated/magma.png'), MessageType.image, { mimetype: Mimetype.png, caption: 'Made by WhatsOwen' })
              })
          } catch(err) { 
              console.log(err)
          } 
...
Owen.addCommand({pattern: 'textmetal ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    thiccysapi.textpro("https://textpro.me/create-a-3d-glossy-metal-text-effect-1019.html",
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsOwenDuplicated/metal.png', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsOwenDuplicated/metal.png'), MessageType.image, { mimetype: Mimetype.png, caption: 'Made by WhatsOwen' })
              })
          } catch(err) { 
              console.log(err)
          } 
...
Owen.addCommand({pattern: 'textpaper ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    thiccysapi.textpro("https://textpro.me/create-art-paper-cut-text-effect-online-1022.html",
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsOwenDuplicated/papert.png', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsOwenDuplicated/papert.png'), MessageType.image, { mimetype: Mimetype.png, caption: 'Made by WhatsOwen' })
              })
          } catch(err) { 
              console.log(err)
          } 
...
Owen.addCommand({pattern: 'textbglass ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    thiccysapi.textpro("https://textpro.me/broken-glass-text-effect-free-online-1023.html",
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsOwenDuplicated/glass.png', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsOwenDuplicated/glass.png'), MessageType.image, { mimetype: Mimetype.png, caption: 'Made by WhatsOwen' })
              })
          } catch(err) { 
              console.log(err)
          } 
...
Owen.addCommand({pattern: 'text5neon ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    thiccysapi.textpro("https://textpro.me/create-3d-neon-light-text-effect-online-1028.html",
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsOwenDuplicated/t5neon.png', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsOwenDuplicated/t5neon.png'), MessageType.image, { mimetype: Mimetype.png, caption: 'Made by WhatsOwen' })
              })
          } catch(err) { 
              console.log(err)
          } 
...
Owen.addCommand({pattern: 'textgradient ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    thiccysapi.textpro("https://textpro.me/online-3d-gradient-text-effect-generator-1020.html",
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsOwenDuplicated/tgrone.png', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsOwenDuplicated/tgrone.png'), MessageType.image, { mimetype: Mimetype.png, caption: 'Made by WhatsOwen' })
              })
          } catch(err) { 
              console.log(err)
          } 
...
Owen.addCommand({pattern: 'text2harry ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    thiccysapi.textpro("https://textpro.me/create-harry-potter-text-effect-online-1025.html",
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsOwenDuplicated/hp2n.png', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsOwenDuplicated/hp2n.png'), MessageType.image, { mimetype: Mimetype.png, caption: 'Made by WhatsOwen' })
              })
          } catch(err) { 
              console.log(err)
          } 
...
Owen.addCommand({pattern: 'textstone ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    thiccysapi.textpro("https://textpro.me/3d-stone-cracked-cool-text-effect-1029.html",
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsOwenDuplicated/stone.png', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsOwenDuplicated/stone.png'), MessageType.image, { mimetype: Mimetype.png, caption: 'Made by WhatsOwen' })
              })
          } catch(err) { 
              console.log(err)
          } 
...
Owen.addCommand({pattern: 'textbear ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    thiccysapi.textpro("https://textpro.me/online-black-and-white-bear-mascot-logo-creation-1012.html",
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsOwenDuplicated/bear.png', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsOwenDuplicated/bear.png'), MessageType.image, { mimetype: Mimetype.png, caption: 'Made by WhatsOwen' })
              })
          } catch(err) { 
              console.log(err)
          } 
...
Owen.addCommand({pattern: 'textwolf ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    var topText, bottomText; 
    if (match[1].includes(';')) {
        var split = match[1].split(';');
        topText = split[0];
    ...
    thiccysapi.textpro("https://textpro.me/create-wolf-logo-galaxy-online-936.html",
        [`${topText}`, `${bottomText}`]
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsOwenDuplicated/wolf.png', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsOwenDuplicated/wolf.png'), MessageType.image, { mimetype: Mimetype.png, caption: 'Made by WhatsOwen' })
              })
          } catch(err) { 
              console.log(err)
          } 
...
Owen.addCommand({pattern: 'textneon ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    thiccysapi.textpro("https://textpro.me/create-a-futuristic-technology-neon-light-text-effect-1006.html",
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsOwenDuplicated/neon.png', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsOwenDuplicated/neon.png'), MessageType.image, { mimetype: Mimetype.png, caption: 'Made by WhatsOwen' })
              })
          } catch(err) { 
              console.log(err)
          } 
...
Owen.addCommand({pattern: 'text2neon ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    thiccysapi.textpro("https://textpro.me/neon-text-effect-online-879.html",
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsOwenDuplicated/neon2.png', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsOwenDuplicated/neon2.png'), MessageType.image, { mimetype: Mimetype.png, caption: 'Made by WhatsOwen' })
              })
          } catch(err) { 
              console.log(err)
          } 
...
Owen.addCommand({pattern: 'textlight ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    thiccysapi.textpro("https://textpro.me/thunder-text-effect-online-881.html",
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsOwenDuplicated/li.png', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsOwenDuplicated/li.png'), MessageType.image, { mimetype: Mimetype.png, caption: 'Made by WhatsOwen' })
              })
          } catch(err) { 
              console.log(err)
          } 
...
Owen.addCommand({pattern: 'textjoker ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    thiccysapi.textpro("https://textpro.me/create-logo-joker-online-934.html",
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsOwenDuplicated/joker.png', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsOwenDuplicated/joker.png'), MessageType.image, { mimetype: Mimetype.png, caption: 'Made by WhatsOwen' })
              })
          } catch(err) { 
              console.log(err)
          } 
...
Owen.addCommand({pattern: 'textninja ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    var topText, bottomText; 
    if (match[1].includes(';')) {
        var split = match[1].split(';');
        topText = split[0];
    ...
    thiccysapi.textpro("https://textpro.me/create-ninja-logo-online-935.html",
        [`${topText}`, `${bottomText}`]
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsOwenDuplicated/ninja.png', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsOwenDuplicated/ninja.png'), MessageType.image, { mimetype: Mimetype.png, caption: 'Made by WhatsOwen' })
              })
          } catch(err) { 
              console.log(err)
          } 
...
Owen.addCommand({pattern: 'textglitter ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    thiccysapi.textpro("https://textpro.me/advanced-glow-text-effect-873.html",
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsOwenDuplicated/tt.png', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsOwenDuplicated/tt.png'), MessageType.image, { mimetype: Mimetype.png, caption: 'Made by WhatsOwen' })
              })
          } catch(err) { 
              console.log(err)
          } 
...
Owen.addCommand({pattern: 'textbokeh ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    thiccysapi.textpro("https://textpro.me/bokeh-text-effect-876.html",
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsOwenDuplicated/bkh.png', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsOwenDuplicated/bkh.png'), MessageType.image, { mimetype: Mimetype.png, caption: 'Made by WhatsOwen' })
              })
          } catch(err) { 
              console.log(err)
          } 
...
Owen.addCommand({pattern: 'textmarvel ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    var topText, bottomText; 
    if (match[1].includes(';')) {
        var split = match[1].split(';');
        topText = split[0];
    ...
    thiccysapi.textpro("https://textpro.me/create-logo-style-marvel-studios-online-971.html",
        [`${topText}`, `${bottomText}`]
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsOwenDuplicated/marvel.png', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsOwenDuplicated/marvel.png'), MessageType.image, { mimetype: Mimetype.png, caption: 'Made by WhatsOwen' })
              })
          } catch(err) { 
              console.log(err)
          } 
...
Owen.addCommand({pattern: 'text2marvel ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    var topText, bottomText; 
    if (match[1].includes(';')) {
        var split = match[1].split(';');
        topText = split[0];
    ...
    thiccysapi.textpro("https://textpro.me/create-3d-avengers-logo-online-974.html",
        [`${topText}`, `${bottomText}`]
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsOwenDuplicated/mar2.png', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsOwenDuplicated/mar2.png'), MessageType.image, { mimetype: Mimetype.png, caption: 'Made by WhatsOwen' })
              })
          } catch(err) { 
              console.log(err)
          } 
...
Owen.addCommand({pattern: 'textavengers ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    var topText, bottomText; 
    if (match[1].includes(';')) {
        var split = match[1].split(';');
        topText = split[0];
    ...
    thiccysapi.textpro("https://textpro.me/create-3d-avengers-logo-online-974.html",
        [`${topText}`, `${bottomText}`]
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsOwenDuplicated/aven.png', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsOwenDuplicated/aven.png'), MessageType.image, { mimetype: Mimetype.png, caption: 'Made by WhatsOwen' })
              })
          } catch(err) { 
              console.log(err)
          } 
...
Owen.addCommand({pattern: 'text2glitch ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    var topText, bottomText; 
    if (match[1].includes(';')) {
        var split = match[1].split(';');
        topText = split[0];
    ...
    thiccysapi.textpro("https://textpro.me/create-a-glitch-text-effect-online-free-1026.html",
        [`${topText}`, `${bottomText}`]
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsOwenDuplicated/t2gl.png', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsOwenDuplicated/t2gl.png'), MessageType.image, { mimetype: Mimetype.png, caption: 'Made by WhatsOwen' })
              })
          } catch(err) { 
              console.log(err)
          } 
...
Owen.addCommand({pattern: 'textglitch ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    var topText, bottomText; 
    if (match[1].includes(';')) {
        var split = match[1].split(';');
        topText = split[0];
    ...
    thiccysapi.textpro("https://textpro.me/create-glitch-text-effect-style-tik-tok-983.html",
        [`${topText}`, `${bottomText}`]
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsOwenDuplicated/tt2.png', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsOwenDuplicated/tt2.png'), MessageType.image, { mimetype: Mimetype.png, caption: 'Made by WhatsOwen' })
              })
          } catch(err) { 
              console.log(err)
          } 
...
Owen.addCommand({pattern: 'textgraf ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    var topText, bottomText; 
    if (match[1].includes(';')) {
        var split = match[1].split(';');
        topText = split[0];
    ...
    thiccysapi.textpro("https://textpro.me/create-cool-wall-graffiti-text-effect-online-1009.html",
        [`${topText}`, `${bottomText}`]
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsOwenDuplicated/ttgra.png', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsOwenDuplicated/ttgra.png'), MessageType.image, { mimetype: Mimetype.png, caption: 'Made by WhatsOwen' })
              })
          } catch(err) { 
              console.log(err)
          } 
...
Owen.addCommand({pattern: 'text2graf ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    var topText, bottomText; 
    if (match[1].includes(';')) {
        var split = match[1].split(';');
        topText = split[0];
    ...
    thiccysapi.textpro("https://textpro.me/create-a-cool-graffiti-text-on-the-wall-1010.html",
        [`${topText}`, `${bottomText}`]
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsOwenDuplicated/t2gra.png', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsOwenDuplicated/t2gra.png'), MessageType.image, { mimetype: Mimetype.png, caption: 'Made by WhatsOwen' })
              })
          } catch(err) { 
              console.log(err)
          } 
...
Owen.addCommand({pattern: 'textlion ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    var topText, bottomText; 
    if (match[1].includes(';')) {
        var split = match[1].split(';');
        topText = split[0];
    ...
    thiccysapi.textpro("https://textpro.me/create-lion-logo-mascot-online-938.html",
        [`${topText}`, `${bottomText}`]
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsOwenDuplicated/lion.png', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsOwenDuplicated/lion.png'), MessageType.image, { mimetype: Mimetype.png, caption: 'Made by WhatsOwen' })
              })
          } catch(err) { 
              console.log(err)
          } 
...
Owen.addCommand({pattern: 'text3neon ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    thiccysapi.textpro("https://textpro.me/neon-text-effect-online-963.html",
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsOwenDuplicated/neon3.png', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsOwenDuplicated/neon3.png'), MessageType.image, { mimetype: Mimetype.png, caption: 'Made by WhatsOwen' })
              })
          } catch(err) { 
              console.log(err)
          } 
...
Owen.addCommand({pattern: 'textice ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    thiccysapi.textpro("https://textpro.me/ice-cold-text-effect-862.html",
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsOwenDuplicated/ice.png', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsOwenDuplicated/ice.png'), MessageType.image, { mimetype: Mimetype.png, caption: 'Made by WhatsOwen' })
              })
          } catch(err) { 
              console.log(err)
          } 
...
Owen.addCommand({pattern: 'textspace ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    var topText, bottomText; 
    if (match[1].includes(';')) {
        var split = match[1].split(';');
        topText = split[0];
    ...
    thiccysapi.textpro("https://textpro.me/create-space-3d-text-effect-online-985.html",
        [`${topText}`, `${bottomText}`]
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsOwenDuplicated/space.png', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsOwenDuplicated/space.png'), MessageType.image, { mimetype: Mimetype.png, caption: 'Made by WhatsOwen' })
              })
          } catch(err) { 
              console.log(err)
          } 
...
Owen.addCommand({pattern: 'textsmoke ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    thiccysapi.photooxy("https://photooxy.com/other-design/create-an-easy-smoke-type-effect-390.html",
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsOwenDuplicated/smoke.png', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsOwenDuplicated/smoke.png'), MessageType.image, { mimetype: Mimetype.png, caption: 'Made by WhatsOwen' })
              })
          } catch(err) { 
              console.log(err)
          } 
...
Owen.addCommand({pattern: 'textglow ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    var download = async(uri, filename, callback) => {
        await request.head(uri, async(err, res, body) => {    
            await request(uri).pipe(fs.createWriteStream(filename)).on('close', callback);
        });
    ...
    await download(`https://api.xteam.xyz/photooxy/neonlight?text=${uri}&APIKEY=da5fb2b73ae3e451`, '/root/WhatsOwenDuplicated/glowttp.png', async() => {                          
        await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsOwenDuplicated/glowttp.png'), MessageType.image, { mimetype: Mimetype.png, caption: 'Made by WhatsOwen' })
    })
}));
Owen.addCommand({pattern: 'textfire ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    thiccysapi.photooxy("https://photooxy.com/logo-and-text-effects/realistic-flaming-text-effect-online-197.html",
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsOwenDuplicated/tfire.png', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsOwenDuplicated/tfire.png'), MessageType.image, { mimetype: Mimetype.png, caption: 'Made by WhatsOwen' })
              })
          } catch(err) { 
              console.log(err)
          } 
...
Owen.addCommand({pattern: 'textharry ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    thiccysapi.photooxy("https://photooxy.com/logo-and-text-effects/create-harry-potter-text-on-horror-background-178.html",
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsOwenDuplicated/hp.png', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsOwenDuplicated/hp.png'), MessageType.image, { mimetype: Mimetype.png, caption: 'Made by WhatsOwen' })
              })
          } catch(err) { 
              console.log(err)
          } 
...
Owen.addCommand({pattern: 'text4neon ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    thiccysapi.photooxy("https://photooxy.com/logo-and-text-effects/illuminated-metallic-effect-177.html",
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsOwenDuplicated/t4n.png', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsOwenDuplicated/t4n.png'), MessageType.image, { mimetype: Mimetype.png, caption: 'Made by WhatsOwen' })
              })
          } catch(err) { 
              console.log(err)
          } 
...
Owen.addCommand({pattern: 'textcemetery ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    thiccysapi.photooxy("https://photooxy.com/logo-and-text-effects/text-on-scary-cemetery-gate-172.html",
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsOwenDuplicated/cmth.png', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsOwenDuplicated/cmth.png'), MessageType.image, { mimetype: Mimetype.png, caption: 'Made by WhatsOwen' })
              })
          } catch(err) { 
              console.log(err)
          } 
...
Owen.addCommand({pattern: 'textcup ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    thiccysapi.photooxy("https://photooxy.com/logo-and-text-effects/put-text-on-the-cup-387.html",
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsOwenDuplicated/cup.png', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsOwenDuplicated/cup.png'), MessageType.image, { mimetype: Mimetype.png, caption: 'Made by WhatsOwen' })
              })
          } catch(err) { 
              console.log(err)
          } 
