...
if (conf.WORKTYPE == 'private') {
    ...
    Owen.addCommand({ pattern: 'voicy', desc: Lang.USAGE, fromMe: true }, (async (message, match) => {
...
if (conf.WORKTYPE == 'public') {
    ...
    Owen.addCommand({ pattern: 'voicy', desc: Lang.USAGE, fromMe: false }, (async (message, match) => {
