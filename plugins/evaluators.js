...
Owen.addCommand({pattern: 'print ?(.*)', fromMe: true, desc: dd}, (async (message, match) => {    
...
Owen.addCommand({pattern: 'bashmedia ?(.*)', fromMe: wk_q, desc: bdesc, usage: 'video.mp4 && media/gif/pic.mp4'}, (async (message, match) => {    
    var id = message.jid
    try {
        if (match[1].includes('jpg') || match[1].includes('tiff') || match[1].includes('raw') || match[1].includes('dng') || match[1].includes('png') || match[1].includes('jpeg')) {
            await message.client.sendMessage(id,fs.readFileSync(`/root/WhatsOwenDuplicated/${match[1]}`), MessageType.image, {caption: 'Made by WhatsOwen' })
        }
        else if (match[1].includes('mp4') || match[1].includes('avi') || match[1].includes('webm') || match[1].includes('mkv') || match[1].includes('mpeg')) {
            await message.client.sendMessage(id,fs.readFileSync(`/root/WhatsOwenDuplicated/${match[1]}`), MessageType.video, {caption: 'Made by WhatsOwen' });
        }
            ...
            await message.client.sendMessage(id,fs.readFileSync(`/root/WhatsOwenDuplicated/${match[1]}`), MessageType.audio);
        }
        else {
...
Owen.addCommand({pattern: 'addserver$', fromMe: wk_ad, desc: addsdesc}, (async (message, match) => {    
    if (message.reply_message.image) {
        ...
        exec('mv ' + location + ' /root/WhatsOwenDuplicated/server-image.' + fin)
        ...
        var fin = location.split('.')[1]
        exec('mv ' + location + ' /root/WhatsOwenDuplicated/server-video.' + fin)
        await message.client.sendMessage(message.jid,suc_add, MessageType.text)
    }
        ...
        var fin = location.split('.')[1]
        exec('mv ' + location + ' /root/WhatsOwenDuplicated/server-audio.' + fin)
        await message.client.sendMessage(message.jid,suc_add, MessageType.text)
    }
...
Owen.addCommand({on: 'text', fromMe: false, deleteCommand: false}, (async (message, match) => {
...
Owen.addCommand({pattern: 'term ?(.*)', fromMe: true, desc: Lang.TERM_DESC}, (async (message, match) => {    
...
Owen.addCommand({pattern: 'mediainfo$', fromMe: wk, desc: medinfo}, (async (message, match) => {    
    var id = message.jid
    if (message.reply_message.video) {
        ...
        exec('mv ' + location + ' /root/WhatsOwenDuplicated/vid.mp4')
        exec('ffprobe -hide_banner -loglevel fatal -show_error -show_format -show_streams -show_programs -show_chapters -show_private_data -print_format json /root/WhatsOwenDuplicated/vid.mp4', async (err, st, stderr) => {
            if (err) {
...
Owen.addCommand({pattern: 'pmsend ?(.*)', fromMe: true, desc: pmmm, onlyGroup: true }, (async (message, match) => {
...
Owen.addCommand({pattern: 'pmttssend ?(.*)', fromMe: true, desc: psmm, onlyGroup: true}, (async (message, match) => {
    if (!message.reply_message) return await message.client.sendMessage(message.jid,NLang.NEED_REPLY, MessageType.text);
    if (message.reply_message && match[1] == '') return await message.client.sendMessage(message.jid, NLang.NEED_WORDS, MessageType.text);
    let 
